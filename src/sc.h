...
bool reduce_horizontal_seam_trivial(cv::Mat& grey, cv::Mat& in_image, cv::Mat& out_image);


bool reduce_vertical_seam_trivial(cv::Mat& grey, cv::Mat& in_image, cv::Mat& out_image);
